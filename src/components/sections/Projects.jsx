...
import { Target, Globe, Layout, Server } from 'lucide-react';
import {ChevronLeft, ChevronRight, Briefcase} from 'lucide-react';
import ProjectCards from "../UserInterface/ProjectCards";
                ...
                <FadeIn delay={0}>
                    <div className="text-center mb-12">
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 border border-primary/30 rounded-full mb-6">
                            ...
                            <span className="text-sm text-primary font-medium uppercase">My Works</span>
                        </div>

                        <h2 className="text-2xl lg:text-3xl font-normal text-white mb-4"> Featured Projects</h2>
