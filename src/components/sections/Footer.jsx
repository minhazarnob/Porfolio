...
import {peronalInfo,socialLinks,Navlinks} from "../../utils/constants";
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                    <FadeIn delay={0}>
                        <div>
                            ...
                            <p className="text-white/80 text-md mb-6 leading-relaxed">
                                {peronalInfo.tagline}
                            </p>
                            ...
                            <div className="space-y-3">
                                <a
                                    ...
                                    className="group flex items-center gap-3 p-3 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 hover:border-primary/30 trnasition-all duration-300"
                                >
                                ...
                                <div className="flex items-center gap-3 p-3 bg-white/5 border border-white/10 rounded-xl">
                                    ...
                                    <span className="text-white/70 text-sm">{peronalInfo.location}</span>
                                </div>
                            </div>
                        </div>
                    </FadeIn>
                    ...
                    <div className="pt-8 border-t border-white/10">
                        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                            <p className="text-white/50 text-sm">
                                {new Date().getFullYear()} {peronalInfo.name}.All right reserved.
                            </p>
                            <p className="flex items-center gap-2 text-white/50 text-sm">
                                Build with <Heart className="w-4 h-4 text-primary fill-primary animate-pulse"/> using React, Tailwind CSS & Django
                            </p>
                        </div>
                    </div>
                </FadeIn>
