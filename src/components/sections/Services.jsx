    ...
    return (
        <section id="services" className="relative py-20 bg-black overflow-hidden">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
                ...
                <FadeIn delay={0}>
                    <div className="text-center mb-16">
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 border border-primary/30 rounded-full mb-6">
                            ...
                            <span className="text-sm text-primary font-medium tracking-wider uppercase">Services</span>
                        </div>
                        <h2 className="text-2xl lg:text-3xl font-normal text-white mb-4 max-w-2xl mx-auto">
                ...
                <div className="grid grid-cols-l lg:grid-cols-2 gap-6 mb-6">
                            ...
                            <FadeIn key={service.id} delay={300 + index * 100}>
                                <div className="group relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-white/60 leading-relaxed line-clamb-3">
                                            {service.description}
                                        </p>
                                    </div>
